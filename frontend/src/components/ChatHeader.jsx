...
function ChatHeaeder() {
    const { setSelectedUser, selectedUser, getMessagesByUserId, messages } = useChatStore();
    ...
    return (
        <div
            ...
            <div className='flex items-center space-x-3'>
                ...
                <div>
                    <h3 className='text-slate-200 font-medium capitalize'>{selectedUser.fullname}</h3>
